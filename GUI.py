import sys, pygame
from Sudoku_Solver import solve_sudoku, get_valid, generate_sudoku
import time
...
class Grid:
    ...
    def place_value(self, val):
        ...
        if self.cubes[row][col].value == 0:
            ...
            if get_valid(self.model, val, (row,col)):
                if generate_sudoku(self.model):
                return True
            else:
